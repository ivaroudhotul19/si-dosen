        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <div class="card-body bg-light" widht="20px">
                    <div class="content">
                      <h4 class="text-center mb-2">Hapus Dosen</h4>
                          <h5 class="text-center mb-4">Ingin Menghapus Data?</h5>
                          <form action="dosen-proses.php" method="post">
                              <input type="hidden" name="id" value="<?= $data['id'] ?>">
                              <div class="d-grid d-flex gap-2 col-3 mx-auto">
                                  <button type="submit" class="btn btn-inverse-danger btn-fw text-center" name="hapus">
                                      YES
                                  </button>
                                  <button type="sumbit" class="btn btn-inverse-warning btn-fw" name="tidak">
                                      NO
                                  </button>
                              </div>
                          </form>
