                    ...
                    <div class="card-body">
                        ...
                        <form action="dosen-proses.php" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control input" name="nip" id="nip" 
                                ...
                                <input type="text" class="form-control input" name="telp" id="telp" 
                                placeholder="Nomor Telp/HP" value="<?= $data['telp'] ?>">
                            </div>
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                <button type="submit" class="btn btn-gradient-primary me-md-2" name="edit">Submit</button>
